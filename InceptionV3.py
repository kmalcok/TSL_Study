...
IMG_SIZE = 224
BATCH_SIZE = 64
EPOCHS = 15  # Daha fazla epoch deneyin
...
model = trainModel()
# Modeli Kaydet
save_model(model, 'InceptionV3_Model.h5', 'InceptionV3_Weights.weights.h5')
# Modeli Yükle
model = load_model('InceptionV3_Model.h5', 'InceptionV3_Weights.weights.h5')
# Modeli Test Et
testModel(model)
