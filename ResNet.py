...
IMG_SIZE = 224
BATCH_SIZE = 64
EPOCHS = 10  # Daha fazla epoch deneyin
...
#model = trainModel()
# Modeli Kaydet
#save_model(model, 'ResNet_Model.h5', 'ResNet_Weights.weights.h5')
# Modeli Yükle
model = load_model('ResNet_Model.h5', 'ResNet_Weights.weights.h5')
# Modeli Test Et
testModel(model)
